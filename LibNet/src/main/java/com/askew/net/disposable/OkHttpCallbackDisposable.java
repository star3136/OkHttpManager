...
import com.askew.net.callback.WrapOkHttpCallback;

/**
 * Created by lihoudong204 on 2018/11/16
 * 既作为{@link OkHttpCallback}的装饰者，又作为IDisposable链上的一个节点
 */
public class OkHttpCallbackDisposable<T> extends WrapOkHttpCallback<T> implements IWrapDisposable {
    private IWrapDisposable delegate;
    private Object tag;

    public OkHttpCallbackDisposable(OkHttpCallback<T> source, Object tag) {
        super(source);
